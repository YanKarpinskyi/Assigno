...
import { enableIndexedDbPersistence } from "https://www.gstatic.com/firebasejs/12.5.0/firebase-firestore.js";
...
enableIndexedDbPersistence(db)
  ...
  .catch((err) => {
    if (err.code === 'failed-precondition') {
      ...
      console.warn("⚠️ Offline persistence is not supported by this browser.");
    } else {
